...
1. Using VS Code, open a new file. Copy and paste all of the example program above into the new file. Save the new 
file as cone_volume.py

2. Run your cone_volume.py program. What error message do you see in the terminal frame?

3. Fix the cone_volume function which begins on line 65 by adding two parameters to its header. What parameter names 
should you use?
Hint:  the parameter names at line 65 and the variable names at line 67 must be the same.

4. Fix the call to the cone_volume function that is in main at line 42 by adding two arguments. Because the 
cone_volume function has two parameters (you added the two parameters in the previous step), each call to cone_volume 
must have two arguments. What variable names should you use for the arguments?
Hint:  the only variables that you can use must be defined inside main above line 42.

5. Fix the call to the cone_volume function that is in main at line 56 by adding two arguments. What variable names 
should you use for the arguments?
Hint:  the only variables that you can use must be defined inside main above line 56.
